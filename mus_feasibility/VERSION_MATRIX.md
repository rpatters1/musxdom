...
The saving product comes from the binary banner, not filenames or timestamps. “ETF likely” means the file should be tested with Finale 2005 or the matching earlier application; it is not a guarantee.

| Saving product | Files | Structural family | Header/body characteristic | MUSX counterparts | ETF likely | Notes |
|---|---:|---|---|---:|---|---|
| apparent Finale 1.8.7–2.6 (archive-derived) | 136 unique archive members | pre-banner | explicit `Finale(TM)` product strings; low-entropy/pre-banner bodies; no Finale 27 exports | none | likely requires older Finale/ETF testing | earliest explicit archive products; no Finale 1.0 yet |
...
| Finale 2000 | 92 | low-entropy legacy | similar low-entropy table/stream family | 91 | yes | useful minimal template available |
...
| Finale 2005 | 120 | high-entropy legacy | same broad family; no zlib | 118 | yes/boundary | highest-priority ETF target |
